    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="col"><button type="button" onclick="saveData('0','','','')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">Add Color</button></div>
            <div class="card">
                <div class="card-body">
                                ...
                                @foreach ($data as $list)
                                    <tr>
                                        ...
                                        <td><button type="button" onclick="saveData('{{$list->id}}','{{$list->text}}','{{$list->link}}','{{$list->image}}')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal"
                                            ...
                                            <button  onclick="deleteData('{{$list->id}}','colors')" class="btn btn-outline-info px-5 radius-30" >Delete</button></td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-tile" id="exampleModalLabel">Color</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="formSubmit" action="{{url('admin/updateManageColor')}}" method="post" enctype="multipart/form-data">
