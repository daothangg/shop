    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="col"><button type="button" onclick="saveData('0','','','')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">Add Category</button></div>
            <div class="card">
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($data as $list)
                                    <tr>
                                        ...
                                        <td><button type="button" onclick="saveData('{{$list->id}}','{{$list->name}}','{{$list->slug}}','{{$list->image}}','{{$list->parent_category_id}}')" class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal">Update</button>
                                            <button  onclick="deleteData('{{$list->id}}','categories')" class="btn btn-outline-info px-5 radius-30" >Delete</button></td>
                                    </tr>
                                @endforeach
                ...
                <form id="formSubmit" action="{{url('admin/updateCategory')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="border p-4 rounded">
                            ...
                            <div class="row mb-3">
                                <label for="enter_link" class="col-sm-3 col-form-label">Slug</label>
                                <div class="col-sm-9">
                                    <input type="text" name="slug" class="form-control" id="enter_link"
