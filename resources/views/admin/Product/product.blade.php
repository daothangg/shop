...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <hr />
            <div class="col"><a href="{{url('admin/manage_product')}}/0"><button type="button"  class="btn btn-outline-info px-5 radius-30" data-bs-toggle="modal"
                data-bs-target="#exampleModal">Add Product</button></a></div>
            <div class="card">
                <div class="card-body">
